...
int ft_CountOddNumberInArray(int arraySource[100], int arraySLength) {
    int i = 0;
...
int main() {
    ...
    int countOddNumber;
    countOddNumber = ft_CountOddNumberInArray(array1, array1length);
    
    cout << "number of odd number is " << countOddNumber << endl;
    return 0;
}