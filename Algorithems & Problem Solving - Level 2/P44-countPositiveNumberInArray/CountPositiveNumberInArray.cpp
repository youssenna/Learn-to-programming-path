...
int ft_CountPositiveNumberInArray(int arraySource[100], int arraySLength) {
    int i = 0;
...
int main() {
    ...
    int countOddNumber;
    countOddNumber = ft_CountPositiveNumberInArray(array1, array1length);
    
    cout << "\nnumber of Positive number is " << countOddNumber << endl;
    return 0;
}